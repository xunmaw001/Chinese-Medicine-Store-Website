...
public class YaocaifenleiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,YaocaifenleiEntity yaocaifenlei, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,YaocaifenleiEntity yaocaifenlei, HttpServletRequest request){
        EntityWrapper<YaocaifenleiEntity> ew = new EntityWrapper<YaocaifenleiEntity>();
		PageUtils page = yaocaifenleiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, yaocaifenlei), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<YaocaifenleiEntity> wrapper = new EntityWrapper<YaocaifenleiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = yaocaifenleiService.selectCount(wrapper);
